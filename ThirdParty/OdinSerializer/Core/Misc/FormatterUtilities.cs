...
You probably need to assign the nullValue variable of the {0} script in the inspector.";
        ...
        static FormatterUtilities()
        {
            ...
            {
                Console.WriteLine("A change in Unity has hindered the Serialization system's ability to create proper fake Unity null values; the UnityEngine.Object.m_UnityRuntimeErrorString field has been renamed or removed.");
            }
#endif
        }
