Shader "NKGMoba/Darius_R_RimLight"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
                ...
                input.positionOS.xyz += _OffsetDir.xyz;
            ...
            half4 frag(Varyings input) : SV_Target
            {
				...
				//计算rimLight
				half4 rimColor = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, float2(clamp(rim, 0.1f, 0.6f), 0.5f));
				return rimColor;
            }
            ENDHLSL
        }
