...
namespace ETHotfix
{
    ...
    public void Awake(GObject go)
    {
        ...
        {	
    		...
    		loginBtn = loginBtn.Create(com.GetChildAt(3));
    		registBtn = RegistBtn.Create(com.GetChildAt(4));
    		accountInput = (GImage)com.GetChildAt(5);
    		passwordInput = (GImage)com.GetChildAt(6);
    		accountText = (GTextInput)com.GetChildAt(7);
    		loginInfo = (GTextField)com.GetChildAt(8);
    		ToTestSceneBtn = ToTestScene.Create(com.GetChildAt(9));
