...
{
    unsafe class ETModel_SpilingInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.SpilingInfo);
            args = new Type[]{};
            method = type.GetMethod("get_UnitId", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_UnitId_0);
            args = new Type[]{};
            method = type.GetMethod("get_ParentUnitId", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_ParentUnitId_1);
            args = new Type[]{};
        ...
        static StackObject* get_UnitId_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.SpilingInfo instance_of_this_method = (ETModel.SpilingInfo)typeof(ETModel.SpilingInfo).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* get_ParentUnitId_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.ParentUnitId;
