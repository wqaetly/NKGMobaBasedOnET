...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_Actor_Test_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("set_ActorId", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_ActorId_1);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("set_Info", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_Info_2);
        ...
        static StackObject* set_ActorId_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            instance_of_this_method.ActorId = value;

            return __ret;
        }

        static StackObject* set_Info_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
