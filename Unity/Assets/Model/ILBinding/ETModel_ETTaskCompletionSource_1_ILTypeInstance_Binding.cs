...
{
    unsafe class ETModel_ETTaskCompletionSource_1_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ETTaskCompletionSource<ILRuntime.Runtime.Intepreter.ILTypeInstance>);
            args = new Type[]{};
        ...
        static StackObject* get_Task_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ETTaskCompletionSource<ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method = (ETModel.ETTaskCompletionSource<ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(ETModel.ETTaskCompletionSource<ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ETModel.ETTaskCompletionSource<ILRuntime.Runtime.Intepreter.ILTypeInstance>();
