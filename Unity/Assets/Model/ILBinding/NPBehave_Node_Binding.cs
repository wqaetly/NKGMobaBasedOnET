...
{
    unsafe class NPBehave_Node_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(NPBehave.Node);
            args = new Type[]{};
        ...
        static StackObject* Start_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            NPBehave.Node instance_of_this_method = (NPBehave.Node)typeof(NPBehave.Node).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
