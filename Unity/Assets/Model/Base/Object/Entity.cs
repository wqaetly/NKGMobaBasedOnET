...
namespace ETModel
{
    ...
    public class Entity: ComponentWithId
    {
        ...
        public virtual K AddComponent<K, P1, P2, P3, P4>(P1 p1, P2 p2, P3 p3, P4 p4) where K : Component, new()
        {
            Type type = typeof (K);
            if (this.componentDict.ContainsKey(type))
            {
            ...
            K component = ComponentFactory.CreateWithParent<K, P1, P2, P3, P4>(this, p1, p2, p3, p4, this.IsFromPool);
