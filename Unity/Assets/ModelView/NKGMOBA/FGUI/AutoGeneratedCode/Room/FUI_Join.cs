...
namespace ET
{
    ...
    {	
        ...
        public static FUI_Join CreateInstance(Entity parent)
        {			
            return parent.AddChild<FUI_Join, GObject>(CreateGObject());
        }
        
       
        public static ETTask<FUI_Join> CreateInstanceAsync(Entity parent)
        {
            ETTask<FUI_Join> tcs = ETTask<FUI_Join>.Create(true);
    
            CreateGObjectAsync((go) =>
            {
                tcs.SetResult(parent.AddChild<FUI_Join, GObject>(go));
            });
        ...
        /// <param name="go"></param>
        /// <returns></returns>
        public static FUI_Join Create(Entity parent, GObject go)
        {
            return parent.AddChild<FUI_Join, GObject>(go);
        }
