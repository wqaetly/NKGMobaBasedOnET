...
namespace Animancer
{
    ...
    public struct AnimationEventReceiver
    {
        ...
        /// <see cref="AnimancerLayer.CurrentStateID"/> changes will actually trigger the <see cref="Callback"/>.
        /// </summary>
        public AnimancerState Source
        {
            ...
            {
                if (_Source == null ||
                    _Source.Layer.CurrentStateID != _SourceID)
                    return null;
            ...
            set
            {
                ...
                if (value != null)
                    _SourceID = value.Layer.CurrentStateID;
            }
        }
        ...
        {
            _Source = source;
            _SourceID = source != null ? source.Layer.CurrentStateID : -1;
        ...
        {
            if (FunctionName == null || _Source == null || _Source.HasEvent(FunctionName))
                return;
        ...
        public bool HandleEvent(AnimationEvent animationEvent)
        {
            ...
            if (_Source != null)
            {
                if (_Source.Layer.CurrentStateID != _SourceID ||
