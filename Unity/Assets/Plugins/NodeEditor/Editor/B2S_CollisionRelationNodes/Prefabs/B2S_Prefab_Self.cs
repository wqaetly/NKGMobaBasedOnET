...
{
    [Node(false, "Box2DSharp/预制件/自己", typeof (B2S_CollisionRelationCanvas))]
    public class B2S_Prefab_Self: Node
    {
        /// <summary>
        /// 内部ID
        /// </summary>
        private const string Id = "自己";
        ...
        {
            this.MB2SCollisionInstance.Flag = "自己";
            this.MB2SCollisionInstance.nodeDataId = 40001;
            this.MB2SCollisionInstance.MB2SAllCollideableObject = B2S_AllCollideableObject.Self;
        }
