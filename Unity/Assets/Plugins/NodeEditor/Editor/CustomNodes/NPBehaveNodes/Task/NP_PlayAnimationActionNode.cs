...
{
    [Node(false, "NPBehave行为树/Task/播放动画", typeof(NPBehaveCanvas))]
    public class NP_PlayAnimationActionNode : NP_TaskNodeBase
    {
        /// <summary>
        /// 内部ID
        /// </summary>
        private const string Id = "播放动画";
        ...
        public NP_ActionNodeData NP_ActionNodeData = new NP_ActionNodeData() { NpClassForStoreAction = new NP_PlayAnimationAction() };
