...
namespace NodeEditorFramework
{
    ...
    {
        public static string editorPath = "Assets/Plugins/NodeEditor/Editor/Node_Editor_Framework/";
        ...
        public static void CheckEditorPath()
        {
            ...
            if (script == null)
            {
                ...
                if (assets.Length != 1)
                {
                    ...
                    if (assets.Length != 1)
                        throw new UnityException("Node Editor: Not installed in default directory '" + editorPath +
                            "'! Correct path could not be detected! Please correct the editorPath variable in NodeEditor.cs!");
                }
                ...
                Debug.LogWarning("Node Editor: Not installed in default directory '" + editorPath + "'! " +
                    "Editor-only automatic detection adjusted the path to " + correctEditorPath +
                    ", but if you plan to use at runtime, please correct the editorPath variable in NodeEditor.cs!");
        ...
        public static bool CheckNodeIsSelected(Node targetNode)
        {
            foreach (var node in curEditorState.selectedNodes)
            {
                if (node == targetNode)
