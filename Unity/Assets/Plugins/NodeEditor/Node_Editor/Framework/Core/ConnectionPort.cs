...
namespace NodeEditorFramework
{
    ...
    public class ConnectionPort: SerializedScriptableObject
    {
        ...
        public virtual ConnectionShape shape
        {
            get
            {
                return ConnectionShape.Line;
            }
        }
        ...
        protected virtual Type styleBaseClass
        {
            get
            {
                return typeof (ConnectionPortStyle);
            }
        }
        ...
        public void Validate(Node nodeBody)
        {
            ...
            if (originalCount != _connections.Count)
                Debug.LogWarning("Removed " + (originalCount - _connections.Count) + " broken (null) connections from node " + body.name +
                    "! Automatically fixed!");
        }
        ...
        public void ApplyConnection(ConnectionPort port, bool silent = false)
        {
            ...
            if (!silent)
            {
                ...
                UndoPro.UndoProManager.RecordOperation(() => NodeEditorUndoActions.CreateConnection(port1, port2),
        ...
        public void RemoveConnection(ConnectionPort port, bool silent = false)
        {
            ...
            if (silent == false && port != null)
            {
                ...
                // Important: Copy variables used within anonymous functions within same level (this if block) for correct serialization!
                ConnectionPort port1 = this, port2 = port;
                UndoPro.UndoProManager.RecordOperation(() => NodeEditorUndoActions.DeleteConnection(port1, port2),
