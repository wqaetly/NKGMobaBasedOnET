...
namespace NodeEditorFramework
{
    ...
    {
        // Connections
        new public List<ValueConnectionKnob> connections
        {
            get
            {
                return _connections.OfType<ValueConnectionKnob>().ToList();
            }
        }
        ...
        protected override Type styleBaseClass
        {
            get
            {
                return typeof (ValueConnectionType);
            }
        }

        new protected ValueConnectionType ConnectionStyle
        {
            get
            {
    ...
    public class ValueConnectionKnobAttribute: ConnectionKnobAttribute
    {
        ...
        public override Type ConnectionType
        {
            get
            {
                return typeof (ValueConnectionKnob);
            }
        }
        ...
        public ValueConnectionKnobAttribute(string name, Direction direction, string type, ConnectionCount maxCount, NodeSide nodeSide,
        float nodeSidePos = 0)
        ...
        public ValueConnectionKnobAttribute(string name, Direction direction, Type type, ConnectionCount maxCount, NodeSide nodeSide,
        float nodeSidePos = 0)
    ...
    public class ValueConnectionType: ConnectionKnobStyle
    {
        ...
        public override bool isValid()
        {
            ...
            if (!valid)
                Debug.LogError("Type " + Identifier + " is invalid! Type-Null?" + (type == null) + ", InTex-Null?" + (InKnobTex == null) +
                    ", OutTex-Null?" + (OutKnobTex == null));
            return valid;
        }
    }
}